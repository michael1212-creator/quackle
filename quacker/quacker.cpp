...
void TopLevel::createWidgets() {
  ...
  connect(m_pliesCombo, SIGNAL(activated(const QString &)), this,
          SLOT(pliesSet(const QString &)));
...
void TopLevel::hints() {
  ...
  msg.setText(tr(
      ...
      "</ul>"
      "<hr>"
      "Hints are generated based on a few AI players and how they might play "
      "in that position. "
      "About the generated hints and what the AI players are:"
      "<ul>"
      "<li>Greedy Player: this AI always plays the highest scoring word."
      " If it cannot form a word, it will exchange as many tiles as "
      ...
      "</ul>"
      "Interestingly enough, Static Player wins about 40% of matches against"
      " Championship Player, putting them within 100 Elo rating of each-other"
      " (<tt><a "
      "href=\"https://en.wikipedia.org/wiki/Elo_rating_system\">https://"
      "en.wikipedia.org/wiki/Elo_rating_system</a></tt>)"
      "<hr>"
