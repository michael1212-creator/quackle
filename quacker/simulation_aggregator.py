...
with open(base_dir + out_file_name, 'w') as f:
    ...
    f.write("The mode number of turns per game is {0} with a count of {1}\n".format(number_of_turns_stats["mode"], number_of_turns_stats["mode_count"]))
    ...
    f.write("{0}'s mode score is {1} with a count of {2}\n".format(p1_name, p1_score_stats["mode"], p1_score_stats["mode_count"]))
    ...
    f.write("{0}'s mode score is {1} with a count of {2}\n".format(p2_name, p2_score_stats["mode"], p2_score_stats["mode_count"]))
    ...
    f.write("{0}'s mean score per turn mode is {1} with a count of {2}\n".format(p1_name, p1_mean_turn_score_stats["mode"], p1_mean_turn_score_stats["mode_count"]))
    ...
    f.write("{0}'s mean score per turn mode is {1} with a count of {2}\n".format(p2_name, p2_mean_turn_score_stats["mode"], p2_mean_turn_score_stats["mode_count"]))
    ...
    f.write("{0} has a mode of {1} bingos per game with a count of {2}.\n".format(p1_name, p1_bingos_stats["mode"], p1_bingos_stats["mode_count"]))
    ...
    f.write("{0} has a mode of {1} bingos per game with a count of {2}.\n".format(p2_name, p2_bingos_stats["mode"], p2_bingos_stats["mode_count"]))
