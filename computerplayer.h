...
inline bool ComputerPlayer::isGreedy() const { return false; }
inline bool ComputerPlayer::isChamp() const { return false; }
inline bool ComputerPlayer::isStatic() const { return false; }
...
inline bool StaticPlayer::isStatic() const { return true; }
...
inline bool GreedyPlayer::isGreedy() const { return true; }
